...
class AppointmentModel extends Model {
  static AppointmentModel of(BuildContext context) =>
      ScopedModel.of<AppointmentModel>(context);
  ...
  getDoctorList() async {
    doctorList = await service.getJobs();
    notifyListeners();
  }
  ...
  Future<ApointmentStatus> bookAppointment(
      {int doctorId, String choseDate}) async {
    var data = {
