...
import 'package:singleclinic/screens/home/components/Slider.dart';
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          //     statusBarColor: Color(0xff002745),
          ...
          //Commented for the update
          //old comment below until another comment indicator
          // Padding(
          //   padding: const EdgeInsets.only(right: 8.0),
          //   child: Stack(
          //     children: <Widget>[
