...
// import 'package:singleclinic/modals/JobsAndServices.dart';

import '../main.dart';
import '../modals/DoctorsAndServices.dart';
...
class _AutoselectBookAppointmentState extends State<AutoselectBookAppointment> {
  ...
  JobsAndServices doctorsAndServices;
  ...
  void initState() {
    ...
    fetchJobsAndServices(widget.departmentId);
  }
  ...
  fetchJobsAndServices(int id) async {
    setState(() {
      doctorValue = null;
      serviceValue = null;
    ...
    if (response.statusCode == 200 && jsonResponse['status'] == 1) {
      setState(() {
        doctorsAndServices = JobsAndServices.fromJson(jsonResponse);
