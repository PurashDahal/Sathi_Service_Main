...
class DoctorAppointmentScreen extends StatefulWidget {
  ...
  const DoctorAppointmentScreen({Key key, this.doctor, this.back})
      : super(key: key);
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  ScopedModelDescendant<AppointmentModel>(
                      builder: (context, _, model) {
                    print(
                        "This is length${widget.doctor.dayAfterTomorrowAvailableTimes.availableTimes.length.toString()}");
                    ...
                    if (widget.doctor.hospitalId != null) {
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (selectedDay == "today") {
                            if (widget.doctor.todayAvailableTimes.availableTimes
                                    .length >
                                0) {
                              currentTime = widget.doctor.todayAvailableTimes
                                  .availableTimes[index];
                              currentSlots = widget
                                  .doctor.todayAvailableTimes.token
                                  .toString();
                            } else {
                            ...
                            if (widget.doctor.tomorrowAvailableTimes
                              ...
                              currentTime = widget.doctor.tomorrowAvailableTimes
                                  .availableTimes[index];
                              currentSlots = widget
                                  .doctor.tomorrowAvailableTimes.token
                                  .toString();
                            } else {
                              currentSlots = 0.toString();
                            }
                            ...
                            if (widget.doctor.dayAfterTomorrowAvailableTimes
                              ...
                              currentTime = widget
                                  ...
                                  .availableTimes[index];
                              currentSlots = widget
                                  .doctor.dayAfterTomorrowAvailableTimes.token
                                  .toString();
                            } else {
                              currentSlots = 0.toString();
                            }
                          ...
                          return InkWell(
                            onTap: () {
                              ...
                              AppointmentModel.of(context).selectedTime =
                                  currentTime;
                              if (selectedDay == "today") {
                                AppointmentModel.of(context).selectedDate =
                                    widget.doctor.todayAvailableTimes.date
                                        .toString();
                              } else if (selectedDay == "tomorrow") {
                                AppointmentModel.of(context).selectedDate =
                                    widget.doctor.tomorrowAvailableTimes.date
                                        .toString();
                              } else if (selectedDay == "dayAfterTomorrow") {
                                AppointmentModel.of(context).selectedDate =
                                    widget.doctor.dayAfterTomorrowAvailableTimes
                      ...
                      return GridView.builder(
                        ...
                        itemCount: selectedDay == "today"
                            ? widget.doctor.todayAvailableTimes.availableTimes
                                .length
                            : selectedDay == "tomorrow"
                                ? widget.doctor.tomorrowAvailableTimes
                                    .availableTimes.length
                            ...
                            actions: [
                              TextButton(
                                  onPressed: () async {
                                    ...
                                    print(
                                        "check this${pickedDate.year}-${month}-${day}");
